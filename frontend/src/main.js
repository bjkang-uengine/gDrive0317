...
pluralCaseList.push( {plural: "aaAgregates", pascal: "AaAgregate"} )

pluralCaseList.push( {plural: "bbAgregates", pascal: "BbAgregate"} )

pluralCaseList.push( {plural: "ccAgregates", pascal: "CcAgregate"} )
